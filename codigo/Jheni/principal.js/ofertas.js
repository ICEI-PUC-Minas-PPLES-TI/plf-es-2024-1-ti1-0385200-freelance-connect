document.addEventListener("DOMContentLoaded", function () {
  ...
  const novaOportunidadeModal = document.getElementById(
    "novaOportunidadeModal"
  );
  const editarOportunidadeModal = document.getElementById(
  ...
  const editarOportunidadeForm = document.getElementById(
    "editarOportunidadeForm"
  );
  const candidatosContainer = document.getElementById("candidatosContainer");

  const apiUrl =
    "https://2d1e5c41-2dfb-4e60-8f66-9d9cb2674904-00-3gvoqjbh3pz4i.kirk.replit.dev/oportunidades";
  const pessoasApiUrl =
    "https://2d1e5c41-2dfb-4e60-8f66-9d9cb2674904-00-3gvoqjbh3pz4i.kirk.replit.dev/pessoa";
    ...
    fetch(apiUrl)
      ...
      .then((oportunidades) => {
        ...
        oportunidades.reverse().forEach((oportunidade) => {
          ...
          viewCandidatesButton.onclick = () =>
            openViewCandidatesModal(oportunidade.candidatos);
  ...
  function openViewCandidatesModal(candidatos) {
    ...
    if (candidatos.length === 0) {
      candidatosContainer.innerHTML =
        "<p>Nenhum candidato para esta oportunidade.</p>";
    } else {
